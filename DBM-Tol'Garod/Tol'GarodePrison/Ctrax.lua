local mod	= DBM:NewMod("Ctrax", "DBM-Tol'Garod", 1)
...
-- 1/40/50 = пул
-- 1/41/11 = омрачающий удар
-- 1/41/11 = сфера тьмы 
-- 1/41/11 = -- 2 фаза и крик "Пора заканчивать, господин ждет меня."
...
function mod:OnCombatStart(delay)
	DBM:FireCustomEvent("DBM_EncounterStart", 84002, "Gogonash")
    warned_P1 = false
	warned_P2 = false
    mod.vb.phase = 1
